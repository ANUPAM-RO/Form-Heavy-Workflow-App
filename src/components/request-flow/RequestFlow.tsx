        ...
        <section className="rounded-3xl border border-white/60 bg-white/80 p-6 shadow-[0_40px_90px_-60px_rgba(21,26,44,0.7)] backdrop-blur-xl md:p-10">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-4">
            <button
              ...
              onClick={handleBack}
              disabled={step === 0}
              className="cursor-pointer rounded-full border border-(--edge) bg-white/70 px-5 py-2 text-sm font-semibold text-(--ink-muted) transition hover:-translate-y-0.5 hover:shadow-sm disabled:cursor-not-allowed disabled:opacity-40"
            >
              Back
            </button>
            <button
              type="button"
              onClick={handleNext}
              className="cursor-pointer rounded-full bg-foreground px-6 py-3 text-sm font-semibold text-white shadow-[0_18px_40px_-18px_rgba(21,26,44,0.7)] transition hover:-translate-y-0.5"
            >
